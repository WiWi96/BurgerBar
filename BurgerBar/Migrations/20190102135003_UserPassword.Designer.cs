...
namespace BurgerBar.Migrations
{
    ...
    [Migration("20190102135003_UserPassword")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BurgerBar.Entities.Bun", b =>
                {
                    ...
                    b.Property<long?>("BottomPictureId");
                    ...
                    b.Property<long?>("TopPictureId");

                    b.HasKey("Id");

                    b.HasIndex("BottomPictureId");

                    b.HasIndex("TopPictureId");
            ...
            modelBuilder.Entity("BurgerBar.Entities.File", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("BurgerBar.Entities.OtherProduct", b =>
                {
                    b.HasBaseType("BurgerBar.Entities.Product");
            ...
            modelBuilder.Entity("BurgerBar.Entities.Bun", b =>
                {
                    b.HasOne("BurgerBar.Entities.File", "BottomPicture")
                        .WithMany()
                        .HasForeignKey("BottomPictureId");

                    b.HasOne("BurgerBar.Entities.File", "TopPicture")
                        .WithMany()
                        .HasForeignKey("TopPictureId");
                });
            ...
            modelBuilder.Entity("BurgerBar.Entities.Ingredient", b =>
                {
                    b.HasOne("BurgerBar.Entities.File", "Picture")
                        .WithMany()
